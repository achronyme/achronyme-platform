...
<div id="hero-section" class="relative px-6 lg:px-8">
    <div class="sm:mt-32 lg:mt-16 container mx-auto text-center">
        <a href="https://github.com/achronyme/achronyme-core" target="_blank" class="inline-flex space-x-6 invisible sm:visible">
            ...
            <span class="inline-flex items-center space-x-2 text-sm/6 font-medium text-gray-600 dark:text-gray-300">
                <span>Lanzamiento de la versión 0.6.4</span>
    ...
    <div class="mx-auto mt-8 max-w-2xl text-center">
        ...
        <p class="mt-8 text-lg font-medium text-pretty text-gray-500 sm:text-xl/8 dark:text-gray-400">Colección modular de utilidades web para el análisis de sistemas y resolución de problemas técnicos. Centralizamos herramientas de PDS, Inteligencia Artificial, Optimización y Ciencias de la Computación en una sola plataforma de código abierto.</p>
    </div>
